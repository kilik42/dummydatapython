...
for name, group in df.groupby('Name'):
    ...
    def generate_pdf(output_path, person_name):
        ...
        def add_header():
            ...
            c.drawString(margin, y_position, person_name)
    ...
    output_file = os.path.join(output_dir, f"{name.replace(' ', '_')}_Contribution_Report.pdf")
    generate_pdf(output_file, name)

print(f"Individual reports have been generated in the '{output_dir}' directory.")

...
# Extract the first and last name dynamically (using the first non-null "Name" value in the data)
...
def generate_pdf(output_path):
    ...
    c.drawString(margin, y_position, first_and_last_name)  # Display the first and last name dynamically
    ...
    y_position -= 20  # Add space before the table
...
# Generate the PDF
output_file = "Final_Contribution_Report_With_Names.pdf"
